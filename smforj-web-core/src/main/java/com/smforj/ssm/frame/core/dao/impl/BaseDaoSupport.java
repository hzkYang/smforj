package com.smforj.ssm.frame.core.dao.impl;
...
import com.smforj.ssm.frame.core.dao.constants.SqlId;
 ...
 *  该类对于单表操作 ,该类继承了SqlSessionDaoSupport对象
 * 
 * @author Haijun Gao 
 * @date 2016-8-10 上午9:21:34
 * @param <T>
 * @desp http://www.cnblogs.com/saga5998/
 * @email 573107773@qq.com
 */
public abstract class BaseDaoSupport<T extends Identifiable> extends SqlSessionDaoSupport implements BaseDao<T> {
	...
	/* (non-Javadoc)
	 * @see com.smforj.core.dao.BaseDao#selectOne(java.io.Serializable)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.smforj.core.dao.BaseDao#selectById(java.io.Serializable)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.smforj.core.dao.BaseDao#selectList(java.io.Serializable)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.smforj.core.dao.BaseDao#selectAll()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.smforj.core.dao.BaseDao#selectMap(java.io.Serializable, java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.smforj.core.dao.BaseDao#selectList(com.smforj.core.dao.domain.Identifiable, org.springframework.data.domain.Pageable)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.smforj.core.dao.BaseDao#selectPageList(com.smforj.core.dao.domain.Identifiable, org.springframework.data.domain.Pageable)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.smforj.core.dao.BaseDao#selectMap(com.smforj.core.dao.domain.Identifiable, java.lang.String, org.springframework.data.domain.Pageable)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.smforj.core.dao.BaseDao#selectCount()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.smforj.core.dao.BaseDao#selectCount(java.io.Serializable)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.smforj.core.dao.BaseDao#insert(java.io.Serializable)
	 */
	@Override
	public int insert(T entity) {
		...
		try {
			...
			return getSqlSession().insert(getSqlName(SqlId.SQL_INSERT), entity);
		} catch (Exception e) {
	...
	/* (non-Javadoc)
	 * @see com.smforj.core.dao.BaseDao#delete(java.io.Serializable)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.smforj.core.dao.BaseDao#deleteById(java.io.Serializable)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.smforj.core.dao.BaseDao#deleteAll()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.smforj.core.dao.BaseDao#updateById(java.io.Serializable)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.smforj.core.dao.BaseDao#updateByIdSelective(java.io.Serializable)
	 */
	@Override
	@Transactional
	...
	/* (non-Javadoc)
	 * @see com.smforj.core.dao.BaseDao#deleteByIdInBatch(java.util.List)
	 */
	@Override
	@Transactional
	...
	/* (non-Javadoc)
	 * @see com.smforj.core.dao.BaseDao#updateInBatch(java.util.List)
	 */
	@Override
	@Transactional
	...
	/* (non-Javadoc)
	 * @see com.smforj.core.dao.BaseDao#insertInBatch(java.util.List)
	 */
	@Override
