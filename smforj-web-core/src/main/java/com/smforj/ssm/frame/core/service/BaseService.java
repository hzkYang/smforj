package com.smforj.ssm.frame.core.service;
...
public interface BaseService<T extends Identifiable> {
	...
	/**
	 * 查询对象列表
	 * @param query 查询参数，如果未null则查询所有，相当于调用方法{@link com.smforj.ssm.frame.core.dao.BaseDao.selectAll }
	 * @return 结果对象列表 
	 */
