...
<script src="${base}/resources/ma/js/jquery.validate.min.js" type="text/javascript"></script> 
<script src="${base}/resources/ma/js/login.js" type="text/javascript"></script> 
