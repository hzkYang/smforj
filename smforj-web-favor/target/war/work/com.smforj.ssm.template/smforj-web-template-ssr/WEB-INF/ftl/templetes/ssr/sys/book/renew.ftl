...
<body> 
	<form class="form-horizontal" id="simple_form" role="form" method="post" action="${base}/wechat/book/renew">
		<div class="modal-header">
			<!--<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>-->
			<h4 class="modal-title" id="myModalLabel">续借</h4>
		</div>
		...
		<div class="modal-footer">
		   <button type="button" class="btn btn-success" id="scan">扫码</button>
			<button type="button" class="btn btn-primary" id="submit">续借</button>
