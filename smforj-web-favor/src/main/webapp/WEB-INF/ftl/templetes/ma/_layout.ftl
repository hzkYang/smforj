...
<head>  
	<title><@spring.message "mindex_title"/></title>
	<#include "/ma/common/meta.ftl">  
	<#include "/ma/common/common-css.ftl">  
</head>
...
<body class="page-header-fixed">
	...
	<div class="header navbar navbar-inverse navbar-fixed-top">
		...
		<div class="navbar-inner">
			...
			<div class="container-fluid">
				...
				<img src="${base}/resources/ma/image/logo.png" alt="logo"/>
				...
				<img src="${base}/resources/ma/image/menu-toggler.png" alt="" />
				...
				<ul class="nav pull-right">
					...
					<li class="dropdown" id="header_inbox_bar">
						...
						<ul class="dropdown-menu extended inbox">
							...
							<li>
								...
								<span class="photo"><img src="${base}/resources/ma/image/avatar2.jpg" alt="" /></span>
							...
							<li>
								...
								<span class="photo"><img src="${base}/resources/ma/image/avatar3.jpg" alt="" /></span>
							...
							<li>
								...
								<span class="photo"><img src="${base}/resources/ma/image/avatar1.jpg" alt="" /></span>
					...
					<li class="dropdown user">
						...
						<img alt="" src="${base}/resources/ma/image/avatar1_small.jpg" />
	...
	<!-- END HEADER -->
    <a href="http://www.mycodes.net/" title="xxxx" target="_blank">xxxxx</a>
	...
	<div class="page-container">
		...
		<!-- BEGIN SIDEBAR -->  
	    <#include "/ma/common/navbar-left.ftl"> 
		<!-- END SIDEBAR -->
							...
							<div class="portlet solid bordered light-grey">
								...
								<div class="portlet-body">
									...
									<div id="site_statistics_loading">
										...
										<img src="${base}/resources/ma/image/loading.gif" alt="loading" />
												...
												<div class="scroller" data-height="290px" data-always-visible="1" data-rail-visible1="1">
													...
													<div class="row-fluid">
														...
														<div class="span6 user-info">
															...
															<img alt="" src="${base}/resources/ma/image/avatar.png" />
									...
									<div class="scroller" data-height="435px" data-always-visible="1" data-rail-visible1="1">
										...
										<ul class="chats">
											...
											<li class="in">
												...
												<img class="avatar" alt="" src="${base}/resources/ma/image/avatar1.jpg" />
											...
											<li class="out">
												...
												<img class="avatar" alt="" src="${base}/resources/ma/image/avatar2.jpg" />
											...
											<li class="out">
												...
												<img class="avatar" alt="" src="${base}/resources/ma/image/avatar3.jpg" />
	...
	<!-- BEGIN JAVASCRIPTS(Load javascripts at bottom, this will reduce page load time) --> 
	 <#include "/ma/common/common-js.ftl"> 
